...
const (
	// Deprecated: use spec.protectOperations.
	PubProtectOperationAnnotation = "kruise.io/pub-protect-operations"
	// Deprecated: use spec.protectTotalReplicas.
	PubProtectTotalReplicasAnnotation = "pub.kruise.io/protect-total-replicas"
	// Deprecated: use spec.ignoredPodSelector.
	PodPubNoProtectionAnnotation = "pub.kruise.io/no-protect"
	// PodRelatedPubAnnotation is the stable internal pod annotation used to cache the owning PUB name.
	PodRelatedPubAnnotation = "pub.kruise.io/related-pub"
	// DeprecatedPodRelatedPubAnnotation is kept for backward compatibility with existing pods.
	DeprecatedPodRelatedPubAnnotation = "kruise.io/related-pub"
...
type PodUnavailableBudgetSpec struct {
	...
	// ProtectOperations declares which voluntary disruption operations are protected by this PUB.
	// When empty, DELETE, UPDATE and EVICT are protected by default.
	// +optional
	...
	// +optional
	IgnoredPodSelector *metav1.LabelSelector `json:"ignoredPodSelector,omitempty"`
}
