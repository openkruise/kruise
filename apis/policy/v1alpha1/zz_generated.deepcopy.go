...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodUnavailableBudgetPodGroupPolicy) DeepCopyInto(out *PodUnavailableBudgetPodGroupPolicy) {
	*out = *in
	if in.GroupSize != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodUnavailableBudgetPodGroupPolicy.
func (in *PodUnavailableBudgetPodGroupPolicy) DeepCopy() *PodUnavailableBudgetPodGroupPolicy {
	if in == nil {
		return nil
	}
	out := new(PodUnavailableBudgetPodGroupPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodUnavailableBudgetStatus) DeepCopyInto(out *PodUnavailableBudgetStatus) {
	*out = *in
	...
	if in.UnavailablePodGroups != nil {
		in, out := &in.UnavailablePodGroups, &out.UnavailablePodGroups
		*out = make(map[string]v1.Time, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
