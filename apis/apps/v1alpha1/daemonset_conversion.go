...
func (ds *DaemonSet) ConvertTo(dst conversion.Hub) error {
	...
	case *v1beta1.DaemonSet:
		...
		// Convert annotation daemonset.kruise.io/progressive-create-pod to scaleStrategy.progressive
...
func (ds *DaemonSet) ConvertFrom(src conversion.Hub) error {
	...
	case *v1beta1.DaemonSet:
		...
		// Convert scaleStrategy.progressive to annotation daemonset.kruise.io/progressive-create-pod
		if dsv1beta1.Spec.ScaleStrategy != nil && dsv1beta1.Spec.ScaleStrategy.Progressive {
