...
func convertInPlaceUpdateStrategyToV1beta1(src *appspub.InPlaceUpdateStrategy, annotations map[string]string) *appspub.InPlaceUpdateStrategy {
	...
	// Convert annotations to spec fields (annotations take precedence over existing spec fields)
	if annotations != nil {
		...
		} else if src != nil && src.ImagePreDownloadParallelism != nil {
			// Fallback to existing spec field if no annotation
			dst.ImagePreDownloadParallelism = src.ImagePreDownloadParallelism
		}
		...
		} else if src != nil && src.ImagePreDownloadTimeoutSeconds != nil {
			// Fallback to existing spec field if no annotation
			dst.ImagePreDownloadTimeoutSeconds = src.ImagePreDownloadTimeoutSeconds
		}
		...
		} else if src != nil && src.ImagePreDownloadMinUpdatedReadyPods != nil {
			// Fallback to existing spec field if no annotation
			dst.ImagePreDownloadMinUpdatedReadyPods = src.ImagePreDownloadMinUpdatedReadyPods
		}
	} else if src != nil {
		// No annotations, just copy existing spec fields
		dst.ImagePreDownloadParallelism = src.ImagePreDownloadParallelism
		dst.ImagePreDownloadTimeoutSeconds = src.ImagePreDownloadTimeoutSeconds
		dst.ImagePreDownloadMinUpdatedReadyPods = src.ImagePreDownloadMinUpdatedReadyPods
	}
