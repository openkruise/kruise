...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloneSetDeletePriorityWeightTerm) DeepCopyInto(out *CloneSetDeletePriorityWeightTerm) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloneSetDeletePriorityWeightTerm.
func (in *CloneSetDeletePriorityWeightTerm) DeepCopy() *CloneSetDeletePriorityWeightTerm {
	if in == nil {
		return nil
	}
	out := new(CloneSetDeletePriorityWeightTerm)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloneSetScaleStrategy) DeepCopyInto(out *CloneSetScaleStrategy) {
	*out = *in
	...
	if in.DeletePriority != nil {
		in, out := &in.DeletePriority, &out.DeletePriority
		*out = make([]CloneSetDeletePriorityWeightTerm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
