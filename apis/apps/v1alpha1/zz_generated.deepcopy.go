...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloneSetDeletePriority) DeepCopyInto(out *CloneSetDeletePriority) {
	*out = *in
	if in.PodNames != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloneSetDeletePriority.
func (in *CloneSetDeletePriority) DeepCopy() *CloneSetDeletePriority {
	if in == nil {
		return nil
	}
	out := new(CloneSetDeletePriority)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloneSetScaleStrategy) DeepCopyInto(out *CloneSetScaleStrategy) {
	*out = *in
	...
	if in.DeletePriority != nil {
		...
		*out = make([]CloneSetDeletePriority, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
