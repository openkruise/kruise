...
func (in *InPlaceUpdateStrategy) DeepCopyInto(out *InPlaceUpdateStrategy) {
	*out = *in
	if in.ImagePreDownloadParallelism != nil {
		in, out := &in.ImagePreDownloadParallelism, &out.ImagePreDownloadParallelism
		*out = new(intstr.IntOrString)
		**out = **in
	}
	if in.ImagePreDownloadTimeoutSeconds != nil {
		in, out := &in.ImagePreDownloadTimeoutSeconds, &out.ImagePreDownloadTimeoutSeconds
		*out = new(int32)
		**out = **in
	}
	if in.ImagePreDownloadMinUpdatedReadyPods != nil {
		in, out := &in.ImagePreDownloadMinUpdatedReadyPods, &out.ImagePreDownloadMinUpdatedReadyPods
		*out = new(int32)
		**out = **in
	}
}
