...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InPlaceUpdatePrediction) DeepCopyInto(out *InPlaceUpdatePrediction) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InPlaceUpdatePrediction.
func (in *InPlaceUpdatePrediction) DeepCopy() *InPlaceUpdatePrediction {
	if in == nil {
		return nil
	}
	out := new(InPlaceUpdatePrediction)
	in.DeepCopyInto(out)
	return out
}
