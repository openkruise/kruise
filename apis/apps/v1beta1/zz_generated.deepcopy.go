...
func (in ReserveOrdinal) DeepCopyInto(out *ReserveOrdinal) {
	{
		in := &in
		*out = make(ReserveOrdinal, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReserveOrdinal.
func (in ReserveOrdinal) DeepCopy() ReserveOrdinal {
	if in == nil {
		return nil
	}
	out := new(ReserveOrdinal)
	in.DeepCopyInto(out)
	return *out
}
