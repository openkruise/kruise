...
e.g. SidecarSet, WorkloadSpread, PodUnavailableBudget, ResourcesDeletionProtection, ContainerLaunchPriority and PersistentPodState. ([#92](https://github.com/openkruise/charts/pull/92), [@hantmac](https://github.com/hantmac))
