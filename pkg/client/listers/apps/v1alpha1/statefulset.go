...
type StatefulSetLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1alpha1.StatefulSet, err error)
...
type statefulSetLister struct {
	listers.ResourceIndexer[*appsv1alpha1.StatefulSet]
}

// NewStatefulSetLister returns a new StatefulSetLister.
func NewStatefulSetLister(indexer cache.Indexer) StatefulSetLister {
	return &statefulSetLister{listers.New[*appsv1alpha1.StatefulSet](indexer, appsv1alpha1.Resource("statefulset"))}
}

// StatefulSets returns an object that can list and get StatefulSets.
func (s *statefulSetLister) StatefulSets(namespace string) StatefulSetNamespaceLister {
	return statefulSetNamespaceLister{listers.NewNamespaced[*appsv1alpha1.StatefulSet](s.ResourceIndexer, namespace)}
}
...
type StatefulSetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1alpha1.StatefulSet, error)
