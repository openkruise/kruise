...
type DaemonSetLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.DaemonSet, err error)
...
type daemonSetLister struct {
	listers.ResourceIndexer[*appsv1beta1.DaemonSet]
}

// NewDaemonSetLister returns a new DaemonSetLister.
func NewDaemonSetLister(indexer cache.Indexer) DaemonSetLister {
	return &daemonSetLister{listers.New[*appsv1beta1.DaemonSet](indexer, appsv1beta1.Resource("daemonset"))}
}

// DaemonSets returns an object that can list and get DaemonSets.
func (s *daemonSetLister) DaemonSets(namespace string) DaemonSetNamespaceLister {
	return daemonSetNamespaceLister{listers.NewNamespaced[*appsv1beta1.DaemonSet](s.ResourceIndexer, namespace)}
}
...
type DaemonSetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.DaemonSet, error)
