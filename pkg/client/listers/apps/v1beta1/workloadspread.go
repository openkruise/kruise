...
type WorkloadSpreadLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.WorkloadSpread, err error)
...
type workloadSpreadLister struct {
	listers.ResourceIndexer[*appsv1beta1.WorkloadSpread]
}
...
func NewWorkloadSpreadLister(indexer cache.Indexer) WorkloadSpreadLister {
	return &workloadSpreadLister{listers.New[*appsv1beta1.WorkloadSpread](indexer, appsv1beta1.Resource("workloadspread"))}
}

// WorkloadSpreads returns an object that can list and get WorkloadSpreads.
func (s *workloadSpreadLister) WorkloadSpreads(namespace string) WorkloadSpreadNamespaceLister {
	return workloadSpreadNamespaceLister{listers.NewNamespaced[*appsv1beta1.WorkloadSpread](s.ResourceIndexer, namespace)}
}
...
type WorkloadSpreadNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.WorkloadSpread, error)
