...
type ContainerRecreateRequestLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.ContainerRecreateRequest, err error)
...
type containerRecreateRequestLister struct {
	listers.ResourceIndexer[*appsv1beta1.ContainerRecreateRequest]
}
...
func NewContainerRecreateRequestLister(indexer cache.Indexer) ContainerRecreateRequestLister {
	return &containerRecreateRequestLister{listers.New[*appsv1beta1.ContainerRecreateRequest](indexer, appsv1beta1.Resource("containerrecreaterequest"))}
}

// ContainerRecreateRequests returns an object that can list and get ContainerRecreateRequests.
func (s *containerRecreateRequestLister) ContainerRecreateRequests(namespace string) ContainerRecreateRequestNamespaceLister {
	return containerRecreateRequestNamespaceLister{listers.NewNamespaced[*appsv1beta1.ContainerRecreateRequest](s.ResourceIndexer, namespace)}
}
...
type ContainerRecreateRequestNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.ContainerRecreateRequest, error)
