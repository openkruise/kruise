...
type PersistentPodStateLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.PersistentPodState, err error)
...
type persistentPodStateLister struct {
	listers.ResourceIndexer[*appsv1beta1.PersistentPodState]
}
...
func NewPersistentPodStateLister(indexer cache.Indexer) PersistentPodStateLister {
	return &persistentPodStateLister{listers.New[*appsv1beta1.PersistentPodState](indexer, appsv1beta1.Resource("persistentpodstate"))}
}

// PersistentPodStates returns an object that can list and get PersistentPodStates.
func (s *persistentPodStateLister) PersistentPodStates(namespace string) PersistentPodStateNamespaceLister {
	return persistentPodStateNamespaceLister{listers.NewNamespaced[*appsv1beta1.PersistentPodState](s.ResourceIndexer, namespace)}
}
...
type PersistentPodStateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.PersistentPodState, error)
