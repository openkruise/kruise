...
type UnitedDeploymentLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.UnitedDeployment, err error)
...
type unitedDeploymentLister struct {
	listers.ResourceIndexer[*appsv1beta1.UnitedDeployment]
}
...
func NewUnitedDeploymentLister(indexer cache.Indexer) UnitedDeploymentLister {
	return &unitedDeploymentLister{listers.New[*appsv1beta1.UnitedDeployment](indexer, appsv1beta1.Resource("uniteddeployment"))}
}

// UnitedDeployments returns an object that can list and get UnitedDeployments.
func (s *unitedDeploymentLister) UnitedDeployments(namespace string) UnitedDeploymentNamespaceLister {
	return unitedDeploymentNamespaceLister{listers.NewNamespaced[*appsv1beta1.UnitedDeployment](s.ResourceIndexer, namespace)}
}
...
type UnitedDeploymentNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.UnitedDeployment, error)
