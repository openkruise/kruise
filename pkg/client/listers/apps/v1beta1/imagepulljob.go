...
type ImagePullJobLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.ImagePullJob, err error)
...
type imagePullJobLister struct {
	listers.ResourceIndexer[*appsv1beta1.ImagePullJob]
}
...
func NewImagePullJobLister(indexer cache.Indexer) ImagePullJobLister {
	return &imagePullJobLister{listers.New[*appsv1beta1.ImagePullJob](indexer, appsv1beta1.Resource("imagepulljob"))}
}

// ImagePullJobs returns an object that can list and get ImagePullJobs.
func (s *imagePullJobLister) ImagePullJobs(namespace string) ImagePullJobNamespaceLister {
	return imagePullJobNamespaceLister{listers.NewNamespaced[*appsv1beta1.ImagePullJob](s.ResourceIndexer, namespace)}
}
...
type ImagePullJobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.ImagePullJob, error)
