...
type AdvancedCronJobLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.AdvancedCronJob, err error)
...
// List lists all AdvancedCronJobs in the indexer.
func (s *advancedCronJobLister) List(selector labels.Selector) (ret []*v1beta1.AdvancedCronJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.AdvancedCronJob))
	})
	return ret, err
}
...
type AdvancedCronJobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.AdvancedCronJob, error)
...
// List lists all AdvancedCronJobs in the indexer for a given namespace.
func (s advancedCronJobNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.AdvancedCronJob, err error) {
...
// Get retrieves the AdvancedCronJob from the indexer for a given namespace and name.
func (s advancedCronJobNamespaceLister) Get(name string) (*v1beta1.AdvancedCronJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("advancedcronjob"), name)
	}
	return obj.(*v1beta1.AdvancedCronJob), nil
}
