...
type ImageListPullJobLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.ImageListPullJob, err error)
...
// List lists all ImageListPullJobs in the indexer.
func (s *imageListPullJobLister) List(selector labels.Selector) (ret []*v1beta1.ImageListPullJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.ImageListPullJob))
	})
	return ret, err
}
...
type ImageListPullJobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.ImageListPullJob, error)
...
// List lists all ImageListPullJobs in the indexer for a given namespace.
func (s imageListPullJobNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.ImageListPullJob, err error) {
...
// Get retrieves the ImageListPullJob from the indexer for a given namespace and name.
func (s imageListPullJobNamespaceLister) Get(name string) (*v1beta1.ImageListPullJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("imagelistpulljob"), name)
	}
	return obj.(*v1beta1.ImageListPullJob), nil
}
