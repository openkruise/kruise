...
type ImageListPullJobLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1beta1.ImageListPullJob, err error)
...
type imageListPullJobLister struct {
	listers.ResourceIndexer[*appsv1beta1.ImageListPullJob]
}
...
func NewImageListPullJobLister(indexer cache.Indexer) ImageListPullJobLister {
	return &imageListPullJobLister{listers.New[*appsv1beta1.ImageListPullJob](indexer, appsv1beta1.Resource("imagelistpulljob"))}
}

// ImageListPullJobs returns an object that can list and get ImageListPullJobs.
func (s *imageListPullJobLister) ImageListPullJobs(namespace string) ImageListPullJobNamespaceLister {
	return imageListPullJobNamespaceLister{listers.NewNamespaced[*appsv1beta1.ImageListPullJob](s.ResourceIndexer, namespace)}
}
...
type ImageListPullJobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1beta1.ImageListPullJob, error)
