...
type advancedCronJobs struct {
	*gentype.ClientWithList[*appsv1beta1.AdvancedCronJob, *appsv1beta1.AdvancedCronJobList]
}
...
func newAdvancedCronJobs(c *AppsV1beta1Client, namespace string) *advancedCronJobs {
	return &advancedCronJobs{
		gentype.NewClientWithList[*appsv1beta1.AdvancedCronJob, *appsv1beta1.AdvancedCronJobList](
			"advancedcronjobs",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *appsv1beta1.AdvancedCronJob { return &appsv1beta1.AdvancedCronJob{} },
			func() *appsv1beta1.AdvancedCronJobList { return &appsv1beta1.AdvancedCronJobList{} },
		),
	}
}
