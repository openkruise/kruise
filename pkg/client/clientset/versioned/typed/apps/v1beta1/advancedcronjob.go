...
type AdvancedCronJobInterface interface {
	Create(ctx context.Context, advancedCronJob *v1beta1.AdvancedCronJob, opts v1.CreateOptions) (*v1beta1.AdvancedCronJob, error)
	Update(ctx context.Context, advancedCronJob *v1beta1.AdvancedCronJob, opts v1.UpdateOptions) (*v1beta1.AdvancedCronJob, error)
	UpdateStatus(ctx context.Context, advancedCronJob *v1beta1.AdvancedCronJob, opts v1.UpdateOptions) (*v1beta1.AdvancedCronJob, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.AdvancedCronJob, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.AdvancedCronJobList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.AdvancedCronJob, err error)
...
func (c *advancedCronJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.AdvancedCronJob, err error) {
	result = &v1beta1.AdvancedCronJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *advancedCronJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.AdvancedCronJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.AdvancedCronJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("advancedcronjobs").
...
func (c *advancedCronJobs) Create(ctx context.Context, advancedCronJob *v1beta1.AdvancedCronJob, opts v1.CreateOptions) (result *v1beta1.AdvancedCronJob, err error) {
	result = &v1beta1.AdvancedCronJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("advancedcronjobs").
...
func (c *advancedCronJobs) Update(ctx context.Context, advancedCronJob *v1beta1.AdvancedCronJob, opts v1.UpdateOptions) (result *v1beta1.AdvancedCronJob, err error) {
	result = &v1beta1.AdvancedCronJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("advancedcronjobs").
...
func (c *advancedCronJobs) UpdateStatus(ctx context.Context, advancedCronJob *v1beta1.AdvancedCronJob, opts v1.UpdateOptions) (result *v1beta1.AdvancedCronJob, err error) {
	result = &v1beta1.AdvancedCronJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("advancedcronjobs").
...
func (c *advancedCronJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.AdvancedCronJob, err error) {
	result = &v1beta1.AdvancedCronJob{}
