...
type EphemeralJobInterface interface {
	Create(ctx context.Context, ephemeralJob *v1beta1.EphemeralJob, opts v1.CreateOptions) (*v1beta1.EphemeralJob, error)
	Update(ctx context.Context, ephemeralJob *v1beta1.EphemeralJob, opts v1.UpdateOptions) (*v1beta1.EphemeralJob, error)
	UpdateStatus(ctx context.Context, ephemeralJob *v1beta1.EphemeralJob, opts v1.UpdateOptions) (*v1beta1.EphemeralJob, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.EphemeralJob, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.EphemeralJobList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.EphemeralJob, err error)
...
func newEphemeralJobs(c *AppsV1beta1Client, namespace string) *ephemeralJobs {
...
func (c *ephemeralJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.EphemeralJob, err error) {
	result = &v1beta1.EphemeralJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ephemeralJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.EphemeralJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.EphemeralJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ephemeraljobs").
...
func (c *ephemeralJobs) Create(ctx context.Context, ephemeralJob *v1beta1.EphemeralJob, opts v1.CreateOptions) (result *v1beta1.EphemeralJob, err error) {
	result = &v1beta1.EphemeralJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ephemeraljobs").
...
func (c *ephemeralJobs) Update(ctx context.Context, ephemeralJob *v1beta1.EphemeralJob, opts v1.UpdateOptions) (result *v1beta1.EphemeralJob, err error) {
	result = &v1beta1.EphemeralJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ephemeraljobs").
...
func (c *ephemeralJobs) UpdateStatus(ctx context.Context, ephemeralJob *v1beta1.EphemeralJob, opts v1.UpdateOptions) (result *v1beta1.EphemeralJob, err error) {
	result = &v1beta1.EphemeralJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ephemeraljobs").
...
func (c *ephemeralJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.EphemeralJob, err error) {
	result = &v1beta1.EphemeralJob{}
