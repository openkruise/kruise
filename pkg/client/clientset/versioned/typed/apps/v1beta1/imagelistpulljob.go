...
type ImageListPullJobInterface interface {
	Create(ctx context.Context, imageListPullJob *v1beta1.ImageListPullJob, opts v1.CreateOptions) (*v1beta1.ImageListPullJob, error)
	Update(ctx context.Context, imageListPullJob *v1beta1.ImageListPullJob, opts v1.UpdateOptions) (*v1beta1.ImageListPullJob, error)
	UpdateStatus(ctx context.Context, imageListPullJob *v1beta1.ImageListPullJob, opts v1.UpdateOptions) (*v1beta1.ImageListPullJob, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ImageListPullJob, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ImageListPullJobList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ImageListPullJob, err error)
...
func (c *imageListPullJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ImageListPullJob, err error) {
	result = &v1beta1.ImageListPullJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *imageListPullJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ImageListPullJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ImageListPullJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("imagelistpulljobs").
...
func (c *imageListPullJobs) Create(ctx context.Context, imageListPullJob *v1beta1.ImageListPullJob, opts v1.CreateOptions) (result *v1beta1.ImageListPullJob, err error) {
	result = &v1beta1.ImageListPullJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imagelistpulljobs").
...
func (c *imageListPullJobs) Update(ctx context.Context, imageListPullJob *v1beta1.ImageListPullJob, opts v1.UpdateOptions) (result *v1beta1.ImageListPullJob, err error) {
	result = &v1beta1.ImageListPullJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagelistpulljobs").
...
func (c *imageListPullJobs) UpdateStatus(ctx context.Context, imageListPullJob *v1beta1.ImageListPullJob, opts v1.UpdateOptions) (result *v1beta1.ImageListPullJob, err error) {
	result = &v1beta1.ImageListPullJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagelistpulljobs").
...
func (c *imageListPullJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ImageListPullJob, err error) {
	result = &v1beta1.ImageListPullJob{}
