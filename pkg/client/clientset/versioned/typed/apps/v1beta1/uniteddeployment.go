...
type UnitedDeploymentInterface interface {
	Create(ctx context.Context, unitedDeployment *appsv1beta1.UnitedDeployment, opts v1.CreateOptions) (*appsv1beta1.UnitedDeployment, error)
	Update(ctx context.Context, unitedDeployment *appsv1beta1.UnitedDeployment, opts v1.UpdateOptions) (*appsv1beta1.UnitedDeployment, error)
	// Add a +genclient:noStatus comment above the type to avoid generating UpdateStatus().
	UpdateStatus(ctx context.Context, unitedDeployment *appsv1beta1.UnitedDeployment, opts v1.UpdateOptions) (*appsv1beta1.UnitedDeployment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*appsv1beta1.UnitedDeployment, error)
	List(ctx context.Context, opts v1.ListOptions) (*appsv1beta1.UnitedDeploymentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *appsv1beta1.UnitedDeployment, err error)
...
type unitedDeployments struct {
	*gentype.ClientWithList[*appsv1beta1.UnitedDeployment, *appsv1beta1.UnitedDeploymentList]
}
...
func newUnitedDeployments(c *AppsV1beta1Client, namespace string) *unitedDeployments {
	return &unitedDeployments{
		gentype.NewClientWithList[*appsv1beta1.UnitedDeployment, *appsv1beta1.UnitedDeploymentList](
			"uniteddeployments",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *appsv1beta1.UnitedDeployment { return &appsv1beta1.UnitedDeployment{} },
			func() *appsv1beta1.UnitedDeploymentList { return &appsv1beta1.UnitedDeploymentList{} },
		),
	}
}
