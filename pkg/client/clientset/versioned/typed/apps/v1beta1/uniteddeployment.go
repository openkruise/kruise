...
type UnitedDeploymentInterface interface {
	Create(ctx context.Context, unitedDeployment *v1beta1.UnitedDeployment, opts v1.CreateOptions) (*v1beta1.UnitedDeployment, error)
	Update(ctx context.Context, unitedDeployment *v1beta1.UnitedDeployment, opts v1.UpdateOptions) (*v1beta1.UnitedDeployment, error)
	UpdateStatus(ctx context.Context, unitedDeployment *v1beta1.UnitedDeployment, opts v1.UpdateOptions) (*v1beta1.UnitedDeployment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.UnitedDeployment, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.UnitedDeploymentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.UnitedDeployment, err error)
...
func newUnitedDeployments(c *AppsV1beta1Client, namespace string) *unitedDeployments {
...
func (c *unitedDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.UnitedDeployment, err error) {
	result = &v1beta1.UnitedDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *unitedDeployments) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.UnitedDeploymentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.UnitedDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("uniteddeployments").
...
func (c *unitedDeployments) Create(ctx context.Context, unitedDeployment *v1beta1.UnitedDeployment, opts v1.CreateOptions) (result *v1beta1.UnitedDeployment, err error) {
	result = &v1beta1.UnitedDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("uniteddeployments").
...
func (c *unitedDeployments) Update(ctx context.Context, unitedDeployment *v1beta1.UnitedDeployment, opts v1.UpdateOptions) (result *v1beta1.UnitedDeployment, err error) {
	result = &v1beta1.UnitedDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("uniteddeployments").
...
func (c *unitedDeployments) UpdateStatus(ctx context.Context, unitedDeployment *v1beta1.UnitedDeployment, opts v1.UpdateOptions) (result *v1beta1.UnitedDeployment, err error) {
	result = &v1beta1.UnitedDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("uniteddeployments").
...
func (c *unitedDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.UnitedDeployment, err error) {
	result = &v1beta1.UnitedDeployment{}
