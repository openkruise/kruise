...
type statefulSets struct {
	*gentype.ClientWithList[*appsv1beta1.StatefulSet, *appsv1beta1.StatefulSetList]
}

// newStatefulSets returns a StatefulSets
func newStatefulSets(c *AppsV1beta1Client, namespace string) *statefulSets {
	return &statefulSets{
		gentype.NewClientWithList[*appsv1beta1.StatefulSet, *appsv1beta1.StatefulSetList](
			"statefulsets",
			c.RESTClient(),
