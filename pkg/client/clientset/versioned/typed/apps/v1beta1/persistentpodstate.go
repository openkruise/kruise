...
type PersistentPodStateInterface interface {
	Create(ctx context.Context, persistentPodState *v1beta1.PersistentPodState, opts v1.CreateOptions) (*v1beta1.PersistentPodState, error)
	Update(ctx context.Context, persistentPodState *v1beta1.PersistentPodState, opts v1.UpdateOptions) (*v1beta1.PersistentPodState, error)
	UpdateStatus(ctx context.Context, persistentPodState *v1beta1.PersistentPodState, opts v1.UpdateOptions) (*v1beta1.PersistentPodState, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.PersistentPodState, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.PersistentPodStateList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PersistentPodState, err error)
...
func newPersistentPodStates(c *AppsV1beta1Client, namespace string) *persistentPodStates {
...
func (c *persistentPodStates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PersistentPodState, err error) {
	result = &v1beta1.PersistentPodState{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *persistentPodStates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PersistentPodStateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.PersistentPodStateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("persistentpodstates").
...
func (c *persistentPodStates) Create(ctx context.Context, persistentPodState *v1beta1.PersistentPodState, opts v1.CreateOptions) (result *v1beta1.PersistentPodState, err error) {
	result = &v1beta1.PersistentPodState{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("persistentpodstates").
...
func (c *persistentPodStates) Update(ctx context.Context, persistentPodState *v1beta1.PersistentPodState, opts v1.UpdateOptions) (result *v1beta1.PersistentPodState, err error) {
	result = &v1beta1.PersistentPodState{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("persistentpodstates").
...
func (c *persistentPodStates) UpdateStatus(ctx context.Context, persistentPodState *v1beta1.PersistentPodState, opts v1.UpdateOptions) (result *v1beta1.PersistentPodState, err error) {
	result = &v1beta1.PersistentPodState{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("persistentpodstates").
...
func (c *persistentPodStates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PersistentPodState, err error) {
	result = &v1beta1.PersistentPodState{}
