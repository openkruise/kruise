...
type ResourceDistributionInterface interface {
	Create(ctx context.Context, resourceDistribution *v1beta1.ResourceDistribution, opts v1.CreateOptions) (*v1beta1.ResourceDistribution, error)
	Update(ctx context.Context, resourceDistribution *v1beta1.ResourceDistribution, opts v1.UpdateOptions) (*v1beta1.ResourceDistribution, error)
	UpdateStatus(ctx context.Context, resourceDistribution *v1beta1.ResourceDistribution, opts v1.UpdateOptions) (*v1beta1.ResourceDistribution, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ResourceDistribution, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ResourceDistributionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ResourceDistribution, err error)
...
func newResourceDistributions(c *AppsV1beta1Client) *resourceDistributions {
...
func (c *resourceDistributions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ResourceDistribution, err error) {
	result = &v1beta1.ResourceDistribution{}
	err = c.client.Get().
...
func (c *resourceDistributions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ResourceDistributionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ResourceDistributionList{}
	err = c.client.Get().
		Resource("resourcedistributions").
...
func (c *resourceDistributions) Create(ctx context.Context, resourceDistribution *v1beta1.ResourceDistribution, opts v1.CreateOptions) (result *v1beta1.ResourceDistribution, err error) {
	result = &v1beta1.ResourceDistribution{}
	err = c.client.Post().
		Resource("resourcedistributions").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *resourceDistributions) Update(ctx context.Context, resourceDistribution *v1beta1.ResourceDistribution, opts v1.UpdateOptions) (result *v1beta1.ResourceDistribution, err error) {
	result = &v1beta1.ResourceDistribution{}
	err = c.client.Put().
		Resource("resourcedistributions").
...
func (c *resourceDistributions) UpdateStatus(ctx context.Context, resourceDistribution *v1beta1.ResourceDistribution, opts v1.UpdateOptions) (result *v1beta1.ResourceDistribution, err error) {
	result = &v1beta1.ResourceDistribution{}
	err = c.client.Put().
		Resource("resourcedistributions").
		Name(resourceDistribution.Name).
...
func (c *resourceDistributions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ResourceDistribution, err error) {
	result = &v1beta1.ResourceDistribution{}
