...
type NodePodProbeInterface interface {
	Create(ctx context.Context, nodePodProbe *v1beta1.NodePodProbe, opts v1.CreateOptions) (*v1beta1.NodePodProbe, error)
	Update(ctx context.Context, nodePodProbe *v1beta1.NodePodProbe, opts v1.UpdateOptions) (*v1beta1.NodePodProbe, error)
	UpdateStatus(ctx context.Context, nodePodProbe *v1beta1.NodePodProbe, opts v1.UpdateOptions) (*v1beta1.NodePodProbe, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.NodePodProbe, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.NodePodProbeList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NodePodProbe, err error)
...
func newNodePodProbes(c *AppsV1beta1Client) *nodePodProbes {
...
func (c *nodePodProbes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NodePodProbe, err error) {
	result = &v1beta1.NodePodProbe{}
	err = c.client.Get().
...
func (c *nodePodProbes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NodePodProbeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NodePodProbeList{}
	err = c.client.Get().
		Resource("nodepodprobes").
...
func (c *nodePodProbes) Create(ctx context.Context, nodePodProbe *v1beta1.NodePodProbe, opts v1.CreateOptions) (result *v1beta1.NodePodProbe, err error) {
	result = &v1beta1.NodePodProbe{}
	err = c.client.Post().
		Resource("nodepodprobes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *nodePodProbes) Update(ctx context.Context, nodePodProbe *v1beta1.NodePodProbe, opts v1.UpdateOptions) (result *v1beta1.NodePodProbe, err error) {
	result = &v1beta1.NodePodProbe{}
	err = c.client.Put().
		Resource("nodepodprobes").
...
func (c *nodePodProbes) UpdateStatus(ctx context.Context, nodePodProbe *v1beta1.NodePodProbe, opts v1.UpdateOptions) (result *v1beta1.NodePodProbe, err error) {
	result = &v1beta1.NodePodProbe{}
	err = c.client.Put().
		Resource("nodepodprobes").
		Name(nodePodProbe.Name).
...
func (c *nodePodProbes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NodePodProbe, err error) {
	result = &v1beta1.NodePodProbe{}
