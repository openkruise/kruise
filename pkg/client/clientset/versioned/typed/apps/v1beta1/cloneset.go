...
type CloneSetInterface interface {
	Create(ctx context.Context, cloneSet *v1beta1.CloneSet, opts v1.CreateOptions) (*v1beta1.CloneSet, error)
	Update(ctx context.Context, cloneSet *v1beta1.CloneSet, opts v1.UpdateOptions) (*v1beta1.CloneSet, error)
	UpdateStatus(ctx context.Context, cloneSet *v1beta1.CloneSet, opts v1.UpdateOptions) (*v1beta1.CloneSet, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.CloneSet, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.CloneSetList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloneSet, err error)
...
func (c *cloneSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CloneSet, err error) {
	result = &v1beta1.CloneSet{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clonesets").
		Name(name).
...
func (c *cloneSets) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.CloneSetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.CloneSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clonesets").
...
func (c *cloneSets) Create(ctx context.Context, cloneSet *v1beta1.CloneSet, opts v1.CreateOptions) (result *v1beta1.CloneSet, err error) {
	result = &v1beta1.CloneSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clonesets").
...
func (c *cloneSets) Update(ctx context.Context, cloneSet *v1beta1.CloneSet, opts v1.UpdateOptions) (result *v1beta1.CloneSet, err error) {
	result = &v1beta1.CloneSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clonesets").
...
func (c *cloneSets) UpdateStatus(ctx context.Context, cloneSet *v1beta1.CloneSet, opts v1.UpdateOptions) (result *v1beta1.CloneSet, err error) {
	result = &v1beta1.CloneSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clonesets").
...
func (c *cloneSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloneSet, err error) {
	result = &v1beta1.CloneSet{}
