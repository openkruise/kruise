...
// PolicyV1beta1Client is used to interact with features provided by the policy.kruise.io group.
type PolicyV1beta1Client struct {
	restClient rest.Interface
}

func (c *PolicyV1beta1Client) PodUnavailableBudgets(namespace string) PodUnavailableBudgetInterface {
