...
type PodUnavailableBudgetInterface interface {
	Create(ctx context.Context, podUnavailableBudget *v1beta1.PodUnavailableBudget, opts v1.CreateOptions) (*v1beta1.PodUnavailableBudget, error)
	Update(ctx context.Context, podUnavailableBudget *v1beta1.PodUnavailableBudget, opts v1.UpdateOptions) (*v1beta1.PodUnavailableBudget, error)
	UpdateStatus(ctx context.Context, podUnavailableBudget *v1beta1.PodUnavailableBudget, opts v1.UpdateOptions) (*v1beta1.PodUnavailableBudget, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.PodUnavailableBudget, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.PodUnavailableBudgetList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PodUnavailableBudget, err error)
...
func (c *podUnavailableBudgets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PodUnavailableBudget, err error) {
	result = &v1beta1.PodUnavailableBudget{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *podUnavailableBudgets) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PodUnavailableBudgetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.PodUnavailableBudgetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("podunavailablebudgets").
...
func (c *podUnavailableBudgets) Create(ctx context.Context, podUnavailableBudget *v1beta1.PodUnavailableBudget, opts v1.CreateOptions) (result *v1beta1.PodUnavailableBudget, err error) {
	result = &v1beta1.PodUnavailableBudget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("podunavailablebudgets").
...
func (c *podUnavailableBudgets) Update(ctx context.Context, podUnavailableBudget *v1beta1.PodUnavailableBudget, opts v1.UpdateOptions) (result *v1beta1.PodUnavailableBudget, err error) {
	result = &v1beta1.PodUnavailableBudget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podunavailablebudgets").
...
func (c *podUnavailableBudgets) UpdateStatus(ctx context.Context, podUnavailableBudget *v1beta1.PodUnavailableBudget, opts v1.UpdateOptions) (result *v1beta1.PodUnavailableBudget, err error) {
	result = &v1beta1.PodUnavailableBudget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podunavailablebudgets").
...
func (c *podUnavailableBudgets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PodUnavailableBudget, err error) {
	result = &v1beta1.PodUnavailableBudget{}
