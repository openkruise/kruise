...
type StatefulSetInformer interface {
	...
	Lister() appsv1alpha1.StatefulSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha1().StatefulSets(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().StatefulSets(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().StatefulSets(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().StatefulSets(namespace).Watch(ctx, options)
			},
		},
		&apisappsv1alpha1.StatefulSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *statefulSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1alpha1.StatefulSet{}, f.defaultInformer)
}

func (f *statefulSetInformer) Lister() appsv1alpha1.StatefulSetLister {
	return appsv1alpha1.NewStatefulSetLister(f.Informer().GetIndexer())
}
