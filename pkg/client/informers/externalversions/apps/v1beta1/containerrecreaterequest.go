...
type ContainerRecreateRequestInformer interface {
	...
	Lister() v1beta1.ContainerRecreateRequestLister
}
...
func (f *containerRecreateRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.ContainerRecreateRequest{}, f.defaultInformer)
}

func (f *containerRecreateRequestInformer) Lister() v1beta1.ContainerRecreateRequestLister {
	return v1beta1.NewContainerRecreateRequestLister(f.Informer().GetIndexer())
}
