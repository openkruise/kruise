...
type ContainerRecreateRequestInformer interface {
	...
	Lister() appsv1beta1.ContainerRecreateRequestLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().ContainerRecreateRequests(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ContainerRecreateRequests(namespace).Watch(context.TODO(), options)
			},
		},
		&apisappsv1beta1.ContainerRecreateRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *containerRecreateRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.ContainerRecreateRequest{}, f.defaultInformer)
}

func (f *containerRecreateRequestInformer) Lister() appsv1beta1.ContainerRecreateRequestLister {
	return appsv1beta1.NewContainerRecreateRequestLister(f.Informer().GetIndexer())
}
