...
type UnitedDeploymentInformer interface {
	...
	Lister() v1beta1.UnitedDeploymentLister
}
...
func (f *unitedDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.UnitedDeployment{}, f.defaultInformer)
}

func (f *unitedDeploymentInformer) Lister() v1beta1.UnitedDeploymentLister {
	return v1beta1.NewUnitedDeploymentLister(f.Informer().GetIndexer())
}
