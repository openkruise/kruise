...
type UnitedDeploymentInformer interface {
	...
	Lister() appsv1beta1.UnitedDeploymentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().UnitedDeployments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().UnitedDeployments(namespace).Watch(context.TODO(), options)
			},
		},
		&apisappsv1beta1.UnitedDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *unitedDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.UnitedDeployment{}, f.defaultInformer)
}

func (f *unitedDeploymentInformer) Lister() appsv1beta1.UnitedDeploymentLister {
	return appsv1beta1.NewUnitedDeploymentLister(f.Informer().GetIndexer())
}
