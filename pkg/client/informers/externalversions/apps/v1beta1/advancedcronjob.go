...
type AdvancedCronJobInformer interface {
	...
	Lister() appsv1beta1.AdvancedCronJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().AdvancedCronJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().AdvancedCronJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().AdvancedCronJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().AdvancedCronJobs(namespace).Watch(ctx, options)
			},
		},
		&apisappsv1beta1.AdvancedCronJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *advancedCronJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.AdvancedCronJob{}, f.defaultInformer)
}

func (f *advancedCronJobInformer) Lister() appsv1beta1.AdvancedCronJobLister {
	return appsv1beta1.NewAdvancedCronJobLister(f.Informer().GetIndexer())
}
