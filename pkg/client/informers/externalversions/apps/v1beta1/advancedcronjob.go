...
type AdvancedCronJobInformer interface {
	...
	Lister() v1beta1.AdvancedCronJobLister
}
...
func (f *advancedCronJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.AdvancedCronJob{}, f.defaultInformer)
}

func (f *advancedCronJobInformer) Lister() v1beta1.AdvancedCronJobLister {
	return v1beta1.NewAdvancedCronJobLister(f.Informer().GetIndexer())
}
