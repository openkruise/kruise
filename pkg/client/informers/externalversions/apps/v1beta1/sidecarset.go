...
type SidecarSetInformer interface {
	...
	Lister() appsv1beta1.SidecarSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().SidecarSets().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().SidecarSets().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().SidecarSets().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().SidecarSets().Watch(ctx, options)
			},
		},
		&apisappsv1beta1.SidecarSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sidecarSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.SidecarSet{}, f.defaultInformer)
}

func (f *sidecarSetInformer) Lister() appsv1beta1.SidecarSetLister {
	return appsv1beta1.NewSidecarSetLister(f.Informer().GetIndexer())
}
