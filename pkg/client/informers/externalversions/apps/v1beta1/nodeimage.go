...
type NodeImageInformer interface {
	...
	Lister() appsv1beta1.NodeImageLister
}
...
func (f *nodeImageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.NodeImage{}, f.defaultInformer)
}

func (f *nodeImageInformer) Lister() appsv1beta1.NodeImageLister {
	return appsv1beta1.NewNodeImageLister(f.Informer().GetIndexer())
}
