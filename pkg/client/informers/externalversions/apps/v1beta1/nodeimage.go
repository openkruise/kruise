...
type NodeImageInformer interface {
	...
	Lister() v1beta1.NodeImageLister
}
...
func (f *nodeImageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.NodeImage{}, f.defaultInformer)
}

func (f *nodeImageInformer) Lister() v1beta1.NodeImageLister {
	return v1beta1.NewNodeImageLister(f.Informer().GetIndexer())
}
