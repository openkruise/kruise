...
type ImageListPullJobInformer interface {
	...
	Lister() appsv1beta1.ImageListPullJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().ImageListPullJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ImageListPullJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ImageListPullJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ImageListPullJobs(namespace).Watch(ctx, options)
			},
		},
		&apisappsv1beta1.ImageListPullJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageListPullJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.ImageListPullJob{}, f.defaultInformer)
}

func (f *imageListPullJobInformer) Lister() appsv1beta1.ImageListPullJobLister {
	return appsv1beta1.NewImageListPullJobLister(f.Informer().GetIndexer())
}
