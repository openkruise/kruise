...
type ImageListPullJobInformer interface {
	...
	Lister() v1beta1.ImageListPullJobLister
}
...
func (f *imageListPullJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.ImageListPullJob{}, f.defaultInformer)
}

func (f *imageListPullJobInformer) Lister() v1beta1.ImageListPullJobLister {
	return v1beta1.NewImageListPullJobLister(f.Informer().GetIndexer())
}
