...
type EphemeralJobInformer interface {
	...
	Lister() v1beta1.EphemeralJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().EphemeralJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().EphemeralJobs(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *ephemeralJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.EphemeralJob{}, f.defaultInformer)
}

func (f *ephemeralJobInformer) Lister() v1beta1.EphemeralJobLister {
	return v1beta1.NewEphemeralJobLister(f.Informer().GetIndexer())
}
