...
type ImagePullJobInformer interface {
	...
	Lister() appsv1beta1.ImagePullJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().ImagePullJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ImagePullJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ImagePullJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ImagePullJobs(namespace).Watch(ctx, options)
			},
		},
		&apisappsv1beta1.ImagePullJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imagePullJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.ImagePullJob{}, f.defaultInformer)
}

func (f *imagePullJobInformer) Lister() appsv1beta1.ImagePullJobLister {
	return appsv1beta1.NewImagePullJobLister(f.Informer().GetIndexer())
}
