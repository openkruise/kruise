...
type BroadcastJobInformer interface {
	...
	Lister() appsv1beta1.BroadcastJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().BroadcastJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().BroadcastJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().BroadcastJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().BroadcastJobs(namespace).Watch(ctx, options)
			},
		},
		&apisappsv1beta1.BroadcastJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *broadcastJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.BroadcastJob{}, f.defaultInformer)
}

func (f *broadcastJobInformer) Lister() appsv1beta1.BroadcastJobLister {
	return appsv1beta1.NewBroadcastJobLister(f.Informer().GetIndexer())
}
