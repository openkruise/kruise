...
type ResourceDistributionInformer interface {
	...
	Lister() appsv1beta1.ResourceDistributionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().ResourceDistributions().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().ResourceDistributions().Watch(context.TODO(), options)
			},
		},
		&apisappsv1beta1.ResourceDistribution{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceDistributionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisappsv1beta1.ResourceDistribution{}, f.defaultInformer)
}

func (f *resourceDistributionInformer) Lister() appsv1beta1.ResourceDistributionLister {
	return appsv1beta1.NewResourceDistributionLister(f.Informer().GetIndexer())
}
