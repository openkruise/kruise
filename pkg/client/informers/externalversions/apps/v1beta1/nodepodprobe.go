...
type NodePodProbeInformer interface {
	...
	Lister() v1beta1.NodePodProbeLister
}
...
func (f *nodePodProbeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.NodePodProbe{}, f.defaultInformer)
}

func (f *nodePodProbeInformer) Lister() v1beta1.NodePodProbeLister {
	return v1beta1.NewNodePodProbeLister(f.Informer().GetIndexer())
}
