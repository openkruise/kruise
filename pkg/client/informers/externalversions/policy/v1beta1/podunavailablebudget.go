...
import (
	...
	v1beta1 "github.com/openkruise/kruise/pkg/client/listers/policy/v1beta1"
...
type PodUnavailableBudgetInformer interface {
	...
	Lister() v1beta1.PodUnavailableBudgetLister
}
...
func NewFilteredPodUnavailableBudgetInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&policyv1beta1.PodUnavailableBudget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *podUnavailableBudgetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyv1beta1.PodUnavailableBudget{}, f.defaultInformer)
}

func (f *podUnavailableBudgetInformer) Lister() v1beta1.PodUnavailableBudgetLister {
	return v1beta1.NewPodUnavailableBudgetLister(f.Informer().GetIndexer())
}
