...
import (
	...
	apispolicyv1beta1 "github.com/openkruise/kruise/apis/policy/v1beta1"
	...
	policyv1beta1 "github.com/openkruise/kruise/pkg/client/listers/policy/v1beta1"
...
type PodUnavailableBudgetInformer interface {
	...
	Lister() policyv1beta1.PodUnavailableBudgetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1beta1().PodUnavailableBudgets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1beta1().PodUnavailableBudgets(namespace).Watch(context.TODO(), options)
			},
		},
		&apispolicyv1beta1.PodUnavailableBudget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *podUnavailableBudgetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apispolicyv1beta1.PodUnavailableBudget{}, f.defaultInformer)
}

func (f *podUnavailableBudgetInformer) Lister() policyv1beta1.PodUnavailableBudgetLister {
	return policyv1beta1.NewPodUnavailableBudgetLister(f.Informer().GetIndexer())
}
