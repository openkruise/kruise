...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloneSetUpdatePriorityTerm) DeepCopyInto(out *CloneSetUpdatePriorityTerm) {
	*out = *in
	in.MatchSelector.DeepCopyInto(&out.MatchSelector)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloneSetUpdatePriorityTerm.
func (in *CloneSetUpdatePriorityTerm) DeepCopy() *CloneSetUpdatePriorityTerm {
	if in == nil {
		return nil
	}
	out := new(CloneSetUpdatePriorityTerm)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloneSetUpdateStrategy) DeepCopyInto(out *CloneSetUpdateStrategy) {
	*out = *in
	...
	if in.Priorities != nil {
		...
		*out = make([]CloneSetUpdatePriorityTerm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
