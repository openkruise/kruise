...
var (
	// supportedGVKList is a list that contains all supported resource group, version, and kind
	// Support CustomResourceDefinition
	/* ADD NEW RESOURCE TYPE HERE*/
	supportedGVKList = []schema.GroupVersionKind{
...
func isSupportedGVK(object runtime.Object) bool {
	if object == nil {
		return false
	}
	objGVK := object.GetObjectKind().GroupVersionKind()
	for _, gvk := range supportedGVKList {
