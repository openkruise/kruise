...
func init() {
	// The ResourcesDeletionProtection gate is checked inside ServiceHandler.Handle via
	// deletionprotection.ValidateServiceDeletion, not at registration time, so that the live
