...
func (h *SidecarSetCreateUpdateHandler) validatingSidecarSetV1alpha1Fn(_ context.Context, obj *appsv1alpha1.SidecarSet, older *appsv1alpha1.SidecarSet) (bool, string, error) {
	v1bata1Obj := &appsv1beta1.SidecarSet{}
	if err := obj.ConvertTo(v1bata1Obj); err != nil {
		return false, "", fmt.Errorf("convert v1alpha1 to v1beta1 failed: %v", err)
	}
	var v1beta1Older *appsv1beta1.SidecarSet
	if older != nil {
		v1beta1Older = &appsv1beta1.SidecarSet{}
		if err := older.ConvertTo(v1beta1Older); err != nil {
			return false, "", fmt.Errorf("convert v1alpha1 to v1beta1 failed: %v", err)
		}
	}
	allErrs := h.validateSidecarSet(v1bata1Obj, v1beta1Older)
	if len(allErrs) != 0 {
...
func (h *SidecarSetCreateUpdateHandler) validateSidecarSetSpec(obj *appsv1beta1.SidecarSet, fldPath *field.Path) field.ErrorList {
	...
	if spec.SpecificNamespace != nil && spec.SpecificNamespace.Namespace != "" && spec.SpecificNamespace.NamespaceSelector != nil {
	...
	} else if spec.SpecificNamespace != nil && spec.SpecificNamespace.NamespaceSelector != nil {
		allErrs = append(allErrs, validateSelector(spec.SpecificNamespace.NamespaceSelector, fldPath.Child("namespaceSelector"))...)
	}
...
func (h *SidecarSetCreateUpdateHandler) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	case appsv1beta1.GroupVersion.Version:
		...
		if req.AdmissionRequest.Operation == admissionv1.Update {
			...
			if err := h.Decoder.DecodeRaw(req.AdmissionRequest.OldObject, oldSidecarSet); err != nil {
				return admission.Errored(http.StatusBadRequest, err)
			}
		}
	...
	case appsv1alpha1.GroupVersion.Version:
		...
		allowed, reason, err := h.validatingSidecarSetV1alpha1Fn(ctx, obj, oldSidecarSet)
		if err != nil {
			return admission.Errored(http.StatusInternalServerError, err)
		}
		return admission.ValidationResponse(allowed, reason)
