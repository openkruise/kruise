...
func TestCloneSetProgressing(t *testing.T) {
	...
	cs := &appsv1beta1.CloneSet{
		Spec: appsv1beta1.CloneSetSpec{
			UpdateStrategy: appsv1beta1.CloneSetUpdateStrategy{RollingUpdate: &appsv1beta1.RollingUpdateCloneSetStrategy{Paused: false}},
		},
		Status: appsv1beta1.CloneSetStatus{
			Conditions: []appsv1beta1.CloneSetCondition{
				{
	...
	tests := []struct {
	...
	}{
		{
			...
			updateSpec: func(cs *appsv1beta1.CloneSet) {
				cs.Spec.UpdateStrategy.RollingUpdate.Paused = true
			},
			wantResult: false,
		},
		{
...
func TestCloneSetPaused(t *testing.T) {
	cs := &appsv1beta1.CloneSet{
		Spec: appsv1beta1.CloneSetSpec{
			UpdateStrategy: appsv1beta1.CloneSetUpdateStrategy{RollingUpdate: &appsv1beta1.RollingUpdateCloneSetStrategy{Paused: true}},
		},
		Status: appsv1beta1.CloneSetStatus{
			Conditions: []appsv1beta1.CloneSetCondition{
				{
	...
	tests := []struct {
	...
	}{
		{
			name: "Not paused",
			modifySpec: func(cs *appsv1beta1.CloneSet) {
				cs.Spec.UpdateStrategy.RollingUpdate.Paused = false
			},
			modifyStatus: func(cs *appsv1beta1.CloneSet) {
				cs.Status.Conditions = nil
			},
