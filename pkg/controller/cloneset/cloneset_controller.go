...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appsv1beta1.CloneSet{}}, &handler.EnqueueRequestForObject{}, predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			oldCS := e.ObjectOld.(*appsv1beta1.CloneSet)
			newCS := e.ObjectNew.(*appsv1beta1.CloneSet)
	...
	*newStatus.CollisionCount = collisionCount
	...
	if !isPreDownloadDisabled {
		if currentRevision.Name != updateRevision.Name {
			...
			if minUpdatedReadyPods, ok := instance.Annotations[appsv1beta1.ImagePreDownloadMinUpdatedReadyPods]; ok {
...
func (r *ReconcileCloneSet) syncCloneSet(
	...
	if podsScaleErr != nil {
		newStatus.Conditions = append(newStatus.Conditions, appsv1beta1.CloneSetCondition{
