...
func (c *commonControl) GetUpdateOptions() *inplaceupdate.UpdateOptions {
	...
	if c.Spec.UpdateStrategy.RollingUpdate != nil && c.Spec.UpdateStrategy.RollingUpdate.InPlaceUpdateStrategy != nil {
		opts.GracePeriodSeconds = c.Spec.UpdateStrategy.RollingUpdate.InPlaceUpdateStrategy.GracePeriodSeconds
	}
	...
	if c.Spec.UpdateStrategy.RollingUpdate != nil && c.Spec.UpdateStrategy.RollingUpdate.PodUpdatePolicy == appsv1beta1.InPlaceOnlyCloneSetPodUpdateStrategyType {
...
func (c *commonControl) ValidateCloneSetUpdate(oldCS, newCS *appsv1beta1.CloneSet) error {
	if newCS.Spec.UpdateStrategy.RollingUpdate == nil || newCS.Spec.UpdateStrategy.RollingUpdate.PodUpdatePolicy != appsv1beta1.InPlaceOnlyCloneSetPodUpdateStrategyType {
		return nil
	}
