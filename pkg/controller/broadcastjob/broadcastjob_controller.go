...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &appsv1beta1.BroadcastJob{}, &handler.TypedEnqueueRequestForObject[*appsv1beta1.BroadcastJob]{}))
	if err != nil {
		return err
	}
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &corev1.Pod{}, &podEventHandler{
		enqueueHandler: handler.TypedEnqueueRequestForOwner[*corev1.Pod](mgr.GetScheme(), mgr.GetRESTMapper(), &appsv1beta1.BroadcastJob{}, handler.OnlyControllerOwner()),
	}))
	if err != nil {
		return err
	}
