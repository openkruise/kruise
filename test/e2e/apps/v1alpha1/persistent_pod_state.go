...
var _ = ginkgo.Describe("PersistentPodState", ginkgo.Label("PersistentPodState", "operation"), func() {
	f := v1alpha1.NewDefaultFramework("persistentpodstates")
	var ns string
	var c clientset.Interface
	var a apiextensionsclientset.Interface
	var d dynamic.Interface
	var kc kruiseclientset.Interface
	var tester *v1alpha1.PersistentPodStateTester
	...
	ginkgo.BeforeEach(func() {
		...
		ns = f.Namespace.Name
		tester = v1alpha1.NewPersistentPodStateTester(c, kc, d, a)
	})
	...
	ginkgo.Context("PersistentPodState functionality", func() {
		...
		ginkgo.It("statefulsetlike node topology", func() {
			...
			tester.CreateDynamicWatchWhiteList([]schema.GroupVersionKind{schema.GroupVersionKind{
				Group:   v1alpha1.StatefulSetLikeTestKind.Group,
				Kind:    v1alpha1.StatefulSetLikeTestKind.Kind,
				Version: v1alpha1.StatefulSetLikeTestKind.Version,
			}})
