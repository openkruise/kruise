...
var _ = ginkgo.Describe("ContainerPriority", ginkgo.Label("ContainerPriority", "operation"), func() {
	f := v1alpha1.NewDefaultFramework("containerpriority")
	var ns string
	var c clientset.Interface
	var kc kruiseclientset.Interface
	var cloneSetTester *v1alpha1.CloneSetTester
	var deploymentTester *v1alpha1.DeploymentTester
	...
	ginkgo.BeforeEach(func() {
		...
		deploymentTester = v1alpha1.NewDeploymentTester(c, ns)
