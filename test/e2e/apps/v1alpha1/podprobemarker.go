...
var _ = ginkgo.Describe("PodProbeMarker", ginkgo.Label("PodProbeMarker", "operation"), func() {
	f := v1alpha1.NewDefaultFramework("podprobemarkers")
	var ns string
	var c clientset.Interface
	var kc kruiseclientset.Interface
	var tester *v1alpha1.PodProbeMarkerTester
	var randStr string
	...
	ginkgo.BeforeEach(func() {
		...
		ns = f.Namespace.Name
		tester = v1alpha1.NewPodProbeMarkerTester(c, kc)
...
func dumpNodePodProbes(c kruiseclientset.Interface, ns string) {
	...
	for _, s := range sl.Items {
		desc, _ := common.RunKubectl("get", "nodepodprobe", s.Name, "-o", "yaml")
