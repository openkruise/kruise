...
var _ = ginkgo.Describe("PullImages", ginkgo.Label("PullImages", "operation"), ginkgo.Serial, func() {
	f := v1alpha1.NewDefaultFramework("imagelistpulljobs")
	var ns string
	var c clientset.Interface
	var kc kruiseclientset.Interface
	var testerForNodeImage *v1alpha1.NodeImageTester
	var testerForImageListPullJob *v1alpha1.ImageListPullJobTester
	...
	ginkgo.BeforeEach(func() {
		...
		testerForImageListPullJob = v1alpha1.NewImageListPullJobTester(c, kc)
