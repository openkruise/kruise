...
var _ = ginkgo.Describe("PodUnavailableBudget", ginkgo.Label("PodUnavailableBudget", "policy"), func() {
	f := v1alpha1.NewDefaultFramework("podunavailablebudget")
	var ns string
	var c clientset.Interface
	var kc kruiseclientset.Interface
	var tester *v1alpha1.PodUnavailableBudgetTester
	var sidecarTester *v1alpha1.SidecarSetTester

	ginkgo.BeforeEach(func() {
		c = f.ClientSet
		kc = f.KruiseClientSet
		ns = f.Namespace.Name
		tester = v1alpha1.NewPodUnavailableBudgetTester(c, kc)
		sidecarTester = v1alpha1.NewSidecarSetTester(c, kc)
	})
