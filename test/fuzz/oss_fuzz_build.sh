...
compile_native_go_fuzzer $SRC/kruise/apis/apps/v1alpha1 FuzzResourceDistributionConversionRoundTrip fuzz_resourcedistribution_conversion_round_trip
...
compile_native_go_fuzzer $SRC/kruise/pkg/webhook/resourcedistribution/validating FuzzValidateResourceDistributionSpecV1beta1 fuzz_validate_resource_distribution_spec_v1beta1
